...
aws iam create-role --role-name DuckbillGroupRole-COP --assume-role-policy-document file://raw/assume-role-trust-policy.json
aws iam create-policy --policy-name DuckbillGroupBilling --policy-document file://raw/billing-policy.json
